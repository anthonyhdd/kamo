...
if (!chromium) {
  console.log('· playwright-core not installed — skipping the replay test (set PW_CORE=<dir with node_modules>)');
  process.exit(0);
}
...
if (!exe) { console.log('· no chromium found — skipping the replay test'); server.close(); process.exit(0); }
